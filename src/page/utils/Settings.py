...
class Settings:
    ...
    def __print_settings(self):
        ...
        LogJunkie.debug("Test Case: {value}".format(value=self.test_case))
    ...
    def test_case(self):
        ...
        if self.__test_case is Undefined:
            self.__test_case = self.__get_value(key="Test_case",
                                                default=Settings.__DEFAULT_TEST_CASE)
